...
export const SORT_OPTIONS: { value: SortValue; label: string }[] = [
  { value: 'updatedAt-desc', label: '最終更新が新しい順' },
  { value: 'updatedAt-asc', label: '最終更新が古い順' },
  { value: 'title-asc', label: 'タイトル順' },
  { value: 'year-desc', label: '放送年が新しい順' },
  { value: 'year-asc', label: '放送年が古い順' }
]
...
export const RecordingsToolbar = ({
  ...
  <fieldset className='flex flex-wrap items-center gap-x-2.5 gap-y-2 border-0 p-0' aria-label='絞り込みと並べ替え'>
    <fieldset
    ...
    <fieldset className='inline-flex flex-wrap gap-1.5 border-0 p-0' aria-label='プロバイダ'>
      {PROVIDERS.map((key) => {
